...
Sendo que o último pacote, `shiny`, será necessário apenas ao criar relatórios interativos.
...
#### Título, subtítulos... Na verdade seções, subseções, não???
...
>
> `r ''` r tufte::quote_footer('--- Daciolo, cabo')
```
